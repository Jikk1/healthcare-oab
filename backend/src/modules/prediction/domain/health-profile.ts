...
export interface LabData {
  ...
  hemoglobin?: number; // гемоглобин, г/л (♀ 120–150, ♂ 130–170)
  hematocrit?: number; // гематокрит, % (♀ 36–46, ♂ 40–50)
  wbc?: number; // лейкоциты, ×10⁹/л (норма 4–9)
  platelets?: number; // тромбоциты, ×10⁹/л (норма 150–400)
  neutrophils?: number; // нейтрофилы, ×10⁹/л (норма 2–7)
  lymphocytes?: number; // лимфоциты, ×10⁹/л (норма 1–3)
  esr?: number; // СОЭ, мм/ч (норма <15–20)
}
